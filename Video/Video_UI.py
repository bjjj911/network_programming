...
class VideoChatUI:
    def __init__(self, window, title):
        ...
        self.label.grid(row=0, colum=0, padx=10, pady=10, rowspan=2, sticky="nsew")

        self.chat_text = tk.Text(window, wrap=tk.WORD, state=tk.DISABLED)
        self.chat.text.grid(row=0, column=1, padx=10, pady=10, sticky="nsew")
    ...
    def receive_message(self, message):
        ...
        self.chat_text.config(state=tk.DIABLED)